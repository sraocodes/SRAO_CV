...
helping a professor (which means less burden on my poor parents, who come from a very innocent generation unaware 
of how the world works) finish their project and I could also learn a few things. For me, learning anything in Science 
felt the same - right now after spending time in many areas, I don't even see any distinction between disciplines. 
Whether it is Darcy's law or Ohm's law, my work and fulfilment was the same as a numerical scientist.
...
They didn't ask me for letters of recommendation or if I had any disease for the visa. They liked my profile based on my 
...
So coming back, despite leaving the PhD program at Paderborn was another experience. While in Germany I learned a lot 
including (Bitte, Danke), but I had to accept my limitations in theoretical physics. I still wanted to complete a PhD 
somewhere, so I kept looking for opportunities. That’s when I received an offer from the University of Louvain in Belgium to work on **modelling the electrical 
